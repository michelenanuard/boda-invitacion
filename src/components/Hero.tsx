    ...
    <section id="inicio" className="paper-texture px-4 pb-16 pt-8 sm:px-6 sm:pb-20 sm:pt-10 md:px-8 md:pb-28">
      <div className="mx-auto max-w-[1500px]">
        ...
        <div className="fine-frame relative overflow-hidden bg-[#211b17] shadow-[0_34px_110px_rgba(33,27,23,0.16)]">
          ...
          <div className="absolute inset-x-4 bottom-4 grid gap-4 sm:inset-x-8 sm:bottom-8 sm:gap-5 lg:grid-cols-[minmax(0,0.95fr)_minmax(340px,0.5fr)] lg:items-end">
            <div className="reveal-soft max-w-3xl text-center text-[#fffdf8] lg:text-left">
              ...
              <p className="mx-auto mt-5 max-w-[20rem] text-base leading-7 text-[#fffdf8] sm:mt-6 sm:max-w-[25rem] sm:text-lg sm:leading-8 lg:mx-0 lg:max-w-xl">
                {data.heroSubtitle}
              </p>
            </div>

            <div className="reveal-soft luxury-card relative mx-auto flex w-full max-w-md flex-col items-center overflow-hidden rounded-[8px] p-5 text-center text-[#211b17] sm:p-8 lg:mr-0">
